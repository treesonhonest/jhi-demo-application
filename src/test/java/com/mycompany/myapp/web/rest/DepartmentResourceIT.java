...
class DepartmentResourceIT {
    ...
    public static Department createEntity(EntityManager em) {
        Department department = new Department().departmentName(DEFAULT_DEPARTMENT_NAME).building(DEFAULT_BUILDING);
        return department;
    }
    ...
    public static Department createUpdatedEntity(EntityManager em) {
        Department department = new Department().departmentName(UPDATED_DEPARTMENT_NAME).building(UPDATED_BUILDING);
        return department;
    }
    ...
    void putNewDepartment() throws Exception {
        ...
        updatedDepartment.departmentName(UPDATED_DEPARTMENT_NAME).building(UPDATED_BUILDING);
    ...
    void partialUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.building(UPDATED_BUILDING);
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.departmentName(UPDATED_DEPARTMENT_NAME).building(UPDATED_BUILDING);
