  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="jhiDemoApp.department.home.createOrEditLabel"
          data-cy="DepartmentCreateUpdateHeading"
          v-text="$t('jhiDemoApp.department.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhiDemoApp.department.departmentName')" for="department-departmentName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhiDemoApp.department.building')" for="department-building">Building</label>
            <input
              type="text"
              class="form-control"
              name="building"
              id="department-building"
              data-cy="building"
              :class="{ valid: !$v.department.building.$invalid, invalid: $v.department.building.$invalid }"
              v-model="$v.department.building.$model"
            />
          </div>
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhiDemoApp.department.location')" for="department-location">Location</label>
